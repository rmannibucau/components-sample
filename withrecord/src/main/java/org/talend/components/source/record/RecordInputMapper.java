package org.talend.components.source.record;
...
@PartitionMapper(name = "RecordInput")
@Documentation("TODO fill the documentation for this mapper")
public class RecordInputMapper implements Serializable {
    ...
    public RecordInputMapper(@Option("configuration") final Configuration configuration,
    ...
    @Split
    public List<RecordInputMapper> split(@PartitionSize final long bundles) {
    ...
    @Emitter
    public RecordInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new RecordInputSource(configuration, service, recordBuilderFactory);
    }
}