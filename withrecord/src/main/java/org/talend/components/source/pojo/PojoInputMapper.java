...
@PartitionMapper(name = "PojoInput")
@Documentation("TODO fill the documentation for this mapper")
public class PojoInputMapper implements Serializable {
    ...
    public PojoInputMapper(@Option("configuration") final Configuration configuration,
    ...
    @Split
    public List<PojoInputMapper> split(@PartitionSize final long bundles) {
    ...
    @Emitter
    public PojoInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new PojoInputSource(configuration, service, recordBuilderFactory);
    }
}