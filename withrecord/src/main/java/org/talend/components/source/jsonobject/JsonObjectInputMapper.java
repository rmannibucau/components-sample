...
@PartitionMapper(name = "JsonObjectInput")
@Documentation("TODO fill the documentation for this mapper")
public class JsonObjectInputMapper implements Serializable {
    ...
    public JsonObjectInputMapper(@Option("configuration") final Configuration configuration,
    ...
    @Split
    public List<JsonObjectInputMapper> split(@PartitionSize final long bundles) {
    ...
    @Emitter
    public JsonObjectInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new JsonObjectInputSource(configuration, service, recordBuilderFactory);
    }
}